        ...
        <>
            <div className="flex justify-between bg-white shadow-md w-full h-16 shadow-heavy-metal-400 p-4 mb-5 sticky top-0 z-50">
                ...
                <div className="flex gap-4 mr-2">
                    ...
                    {user ? <button onClick={Logout} className="bg-green-600 text-white active:bg-green-500 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button">
                        Logout
                    </button>
                        : <button onClick={() => {
                            navigate('/login')
                    ...
                    {user ? <Link to="/profile"> <div className='w-28 h-8  bg-white rounded-md  overflow-hidden shadow-sm shadow-gray-500'>

                        <div className='flex px-3'>
                            <img src={ProfileIcon} className='w-5 h-5 mt-2' alt="" />
                            <h1 className='text-gray-500 font-thin text-xl ml-3 mt-1'> {user} </h1>
                        </div>
                    </div>
                    </Link> : ""}
                </div>
