    ...
    <div className='w-[300px] h-[600px] bg-white overflow-y-scroll '>
        ...
        <div className='flex'>
            ...
            <div className='flex justify-center'>
                <h1 className='text-[20px] text-end mt-8 mx-3'>Name :<span>Shibil</span></h1>
            </div>
        </div>
        <hr className='mt-6' />
        ...
        <div className='flex'>
            ...
            <div className='flex justify-center'>
                <h1 className='text-[20px] text-end mt-8 mx-3'>Location:<span>Calicut</span></h1>
            </div>
        </div>
        <hr className='mt-6' />
        ...
        <div className='grid-flow-row'>
            ...
            <div className='flex justify-center'>
               <div className='grid grid-cols-3 gap-10 mt-3'>
                 <div className='bg-gray-100'><span className='text-xl font-medium w-[100px] rounded-2xl '>Type 1</span></div>
                 <div className='bg-gray-100'><span className='text-xl font-medium w-[100px] rounded-2xl '>Type 2</span></div>
                 <div className='bg-gray-100'><span className='text-xl font-medium w-[100px] rounded-2xl '>Tesla</span></div>
        ...
        <div className='grid-flow-row'>
            ...
            <div className='flex justify-center'>
               <div className=' mt-3'>
               <div className=''><h1 className='text-[18px] font-semibold '>When :<span className='text-sm'>Every Day -24 hours</span></h1></div>
                 <div className=''><h1 className='text-[18px] font-semibold'>Cost :<span className='text-sm'>$2</span></h1></div>
               </div>
            </div>
        </div>
        ...
        <hr className='mt-6' />
     <div className='mt-6 '>
          <button className=' bg-green-600 h-[50px] w-full text-2xl text-white font-bold mb-5 rounded-xl '>Booking Now</button>
     </div>
