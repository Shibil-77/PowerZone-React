...
function Profile() {
  return (
    <div className=' py-6 md:mx-20 mx-4 rounded-3xl bg-white w-full md:w-8/12'>
        ...
        <div className='px-6 bg-[#c2c2c228] shadow-xl w-10/12 mt-12 rounded-3xl'>
          ...
          {/* <h1 >Email : <span>Hai</span></h1> */}
          </div>
        </div>
    
      <div className='w-10/12 lg:gap-10 sm:gap-1 mt-20  grid xl:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 lg:grid-cols-4  rounded-3xl'>
        <NavLink>
        ...
        <NavLink>
         ...
         <NavLink>
         <div className='bg-[#c2c2c228] shadow-xl rounded-3xl'>
         <h1 className='text-center font-bold mt-5'>Port Bookings</h1>
