    ...
    <footer className="text-center bg-white text-black mt-20">
      ...
      <div className="mb-6">
        ...
        <ul className="list-none mb-0">
          <li>
            <a href="#!" className="text-black mt-20">Link 1</a>
          </li>
          <li>
            <a href="#!" className="text-black mt-20">Link 2</a>
          </li>
          <li>
            <a href="#!" className="text-black mt-20">Link 3</a>
          </li>
          <li>
            <a href="#!" className="text-black mt-20">Link 4</a>
          </li>
        </ul>
      </div>
      ...
      <div className="text-center p-4" >
        © 2021 Copyright:
        <a className="text-black mt-20" href="https://tailwind-elements.com/">Tailwind Elements</a>
      </div>
    </footer>
  )
}
