...
const AdminSideBar = () => {
  ...
  const Menus = [
    ...
    { title: "Add a charging point", src: Icons, link: '/admin/UsersDetails' },
    { title: "Find a Charging point", src: QueryStatsIcon, link: '/admin/AddBanner' },
    { title: "Bookings ", src: EventNoteIcon, link: '/admin/BookingDetails' },
    { title: "Requests", src: ThreePSharpIcon, link: '/admin/PortDetails' },
